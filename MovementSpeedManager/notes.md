This is the Stats class, extracted from the game's assembly.
...
public class Stats : MonoBehaviour
{
	...
	public void AssignPoint()
	{
		...
		if (Myself.MyNPC.ThisSim.SkillLevel < 32f)
		{
		...
		if (Myself.MyNPC.ThisSim.SkillLevel >= 32f && Myself.MyNPC.ThisSim.SkillLevel < 48f)
		{
			switch (CharacterClass.ClassName)
			{
			case "Paladin":
		...
		if (Myself.MyNPC.ThisSim.SkillLevel >= 48f)
		{
			switch (CharacterClass.ClassName)
			{
			case "Paladin":
