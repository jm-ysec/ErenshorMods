...
| Placeholder | Example |
|---|---|
| `DruidSpells` | `ErenshorMyMod` |
| `DruidSpells` | `MyModName` |
| `Adds custom Druid spells including Spirit of the Wolf` | `My cool Erenshor mod` |
| `DruidSpells` | `MyModLogic` |
| `druidspells` | `my_mod` |
| `Druid Spells` | `My Cool Mod` |
